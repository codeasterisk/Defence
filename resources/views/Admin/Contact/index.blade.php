    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">الشكاوي والاقتراحات</h4> </div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    <li><a href="/dashboard">لوحة التحكم</a></li>
                    <li class="active"> الشكاوي والاقتراحات </li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
                        ...
                        <div class="col-lg-2 col-md-3  col-sm-12 col-xs-12 inbox-panel">
                            <div> <a href="#" class="btn btn-custom btn-block waves-effect waves-light">العمليات</a>
                                <div class="list-group mail-list m-t-20">
                                    <a href="#" class="list-group-item active">الرسائل المستقبلة<span class="label label-rouded label-success pull-right">{{count(\App\Contactus::all())}}</span></a>

                                    <a href="#" class="list-group-item active m-t-20">المقروء<span class="label label-rouded label-info pull-right">{{count(\App\Contactus::where('status',1)->get())}}</span></a>

                                    <a href="#" class="list-group-item active m-t-20">الغير مقروء<span class="label label-rouded label-danger pull-right">{{count(\App\Contactus::where('status',0)->get())}}</span></a>
                                </div>
                            </div>
                        </div>
          ...
          handleClick: function(event) {
              ...
              swal({
                  ...
                  if(isConfirm){
                      ...
                      swal("تم الغاؤه", "تم الغاء حذف الرسالة", "جيد ");
                  }
              });
