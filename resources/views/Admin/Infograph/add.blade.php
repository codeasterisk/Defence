...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">الانفوجرافيكس</h4> </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="/dashboard">لوحة التحكم</a></li>
                <li><a href="/dashboard/infographics">الانفوجرافيكس</a></li>
                <li class="active">اضافة انفوجراف جديد</li>
            </ol>
        </div>
        <!-- /.col-lg-12 -->
    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="white-box">
            <h3 class="box-title m-b-10 text-center">اضافة انفوجراف جديد</h3>
            <div class="row">
                <div class="col-sm-12 col-xs-12">

                    {!!Form::open( ['url' => '/dashboard/infographics/' , 'method' => 'Post','files'=>true]) !!}
                    @include('Admin.Infograph.form')
                    {!!Form::close() !!}
                </div>
            </div>
        </div>
