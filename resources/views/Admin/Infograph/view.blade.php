...
@section('content')
  <div class="container-fluid">
    <div class="row bg-title">
      ...
      <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
          ...
          <li class="active">view {{$career->name}}</li>
        </ol>
      </div>
      <!-- /.col-lg-12 -->
    </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-12">
        <div class="white-box">
          <h3 class="box-title m-b-0">{{$career->name}} Applicants</h3>
          <p class="text-muted m-b-30">Controlling {{$career->name}} Applicants</p>
              ...
              <tr>
                ...
                <td class="text-nowrap">
                  <a href="/dashboard/applicants/{{$applicant->id}}" data-toggle="tooltip" data-original-title="View"> <i class="fa fa-search text-inverse m-r-10"></i> </a>
                    <a href="/dashboard/applicants/{{$applicant->id}}" id="delete-btn"  data-toggle="tooltip" data-original-title="Delete"> <i class="fa fa-trash -o text-danger"></i></a>
                </td>
              </tr>
                @endforeach
              </tbody>
