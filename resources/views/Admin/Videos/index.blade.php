...
@section('content')
  <div class="container-fluid">
    <div class="row bg-title">
      ...
      <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
          ...
          <li><a href="/dashboard/videos">الفيديوهات</a></li>
    ...
    <div class="row">
      ...
      <div class="col-sm-12">
        <div class="white-box">
          <h3 class="box-title m-b-0">الفيديوهات</h3>
          <p class="text-muted m-b-30">التحكم بالفيديوهات</p>
            ...
            <table id="example23" class="display nowrap" cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <td class="text-nowrap">
                  <a href="/dashboard/videos/{{$video->id}}/edit" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
                    <a href="/dashboard/videos/destroy/{{$video->id}}" id="delete-btn"  data-toggle="tooltip" data-original-title="Delete"> <i class="fa fa-trash -o text-danger"></i></a>
                </td>
              </tr>
                @endforeach
              </tbody>
          ...
          handleClick: function(event) {
              ...
              swal({
                  ...
                  if(isConfirm){
                      ...
                      swal("تم الإلغاء", "حذف الفيديو تم الغاؤه", "جيد");
                  }
              });
