    ...
    <div class="row bg-title">
      ...
      <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
          ...
          <li><a href="/dashboard/news">الأخبار</a></li>
    ...
    <div class="row">
      ...
      <div class="col-sm-12">
        <div class="white-box">
          ...
          <p class="text-muted m-b-30">التحكم بالأخبار</p>
            ...
            <table id="example23" class="display nowrap" cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <td>{{$new->title}}</td>
                  ...
                  <td>
                      <span class="label label-primary">{{$new->category->title}}</span>
                  </td>
                ...
                <td class="text-nowrap">
                  <a href="/dashboard/news/{{$new->id}}/edit" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
                    <a href="/dashboard/news/destroy/{{$new->id}}" id="delete-btn"  data-toggle="tooltip" data-original-title="Delete"> <i class="fa fa-trash -o text-danger"></i></a>
                </td>
              </tr>
                @endforeach
              </tbody>
