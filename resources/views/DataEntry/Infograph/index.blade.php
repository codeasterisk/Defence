    ...
    <div class="row bg-title">
      ...
      <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
          ...
          <li><a href="/editors/infographics">الانفوجراف</a></li>
          <li class="active">الانفوجراف الخاص بي</li>
        </ol>
      </div>
      <!-- /.col-lg-12 -->
    </div>
            ...
            <table id="example23" class="display nowrap" cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <td class="text-nowrap">
                  <a href="/editors/infographics/{{$graph->id}}/edit" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
                </td>
              </tr>
                @endforeach
              </tbody>
