    ...
    <div class="row bg-title">
      ...
      <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
          ...
          <li><a href="/editors/videos">الفيديوهات</a></li>
    ...
    <div class="row">
      ...
      <div class="col-sm-12">
        <div class="white-box">
          ...
          <p class="text-muted m-b-30">التحكم بفيديوهاتي</p>
            ...
            <table id="example23" class="display nowrap" cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <td class="text-nowrap">
                  <a href="/editors/videos/{{$video->id}}/edit" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
                </td>
              </tr>
                @endforeach
              </tbody>
