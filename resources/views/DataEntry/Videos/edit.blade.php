...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <h3 class="box-title m-b-0">تعديل {{$video->title}}</h3>
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">

                            {!!Form::model($video , ['url' => ['/editors/videos/'. $video->id] , 'method' => 'PATCH']) !!}
                            @include('DataEntry.Videos.form')
                            {!!Form::close() !!}
                        </div>
                    </div>
                </div>
...
@section('footer')
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $('.cat').val('{{$video->cat_id}}').trigger('change');
