...
<head>
  ...
  <!-- color CSS -->
  <link href="/admin/assets/css/colors/green-dark.css" id="theme" rel="stylesheet">
...
<div id="wrapper">
  ...
  <nav class="navbar navbar-default navbar-static-top m-b-0">
    <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
      <div class="top-left-part text-center"><a class="logo" href="{{ url('/') }}"><b><!--This is dark logo icon--><img src="{{ getimg(getsetting('logo')) }}" width="45" alt="home" class="dark-logo" /></a></div>
      <ul class="nav navbar-top-links navbar-left hidden-xs">
        <li><a href="javascript:void(0)" class="open-close hidden-xs waves-effect waves-light"><i class="icon-arrow-left-circle ti-menu"></i></a></li>
      </ul>
        <h3 style="color: white; text-align: center;">لوحة تحكم المحررين بالموقع</h3>
      ...
      <div class="user-profile">
        <div class="dropdown user-pro-body">
          ...
          <ul class="dropdown-menu animated flipInY">
            <li><a href="/editors/profile"><i class="ti-user"></i>البروفايل الشخصي</a></li>
  ...
  <!-- Page Content -->
  <div id="page-wrapper" class="animated bounceInDown">
  @yield('content')
    <!-- /.container-fluid -->
