...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"البداية",sLast:"النهاية",sNext:"التالي",sPrevious:"السابق"},sEmptyTable:"لا توجد بيانات",sInfo:"يتم إظهار الصفوف بدءاً من _START_ إلى _END_ من _TOTAL_ صف",sInfoEmpty:"",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"يتم التحميل...",sProcessing:"تتم المعالجة...",sSearch:"إبحث:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"لاتوجد نتائج متوافقة لبحثك"},
